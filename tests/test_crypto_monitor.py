...
class DummyProvider:
    def __init__(self, currency="dummy", last_parsed_block=0, last_block_value=5):
...
class TestParseAllBlocks(unittest.TestCase):
    def setUp(self):
        ...
        self.provider_default = DummyProvider(currency="dummy", last_parsed_block=0, last_block_value=5)
    ...
    def test_parse_all_blocks_provider_non_zero(self):
        provider_non_zero = DummyProvider(currency="dummy", last_parsed_block=3, last_block_value=5)
